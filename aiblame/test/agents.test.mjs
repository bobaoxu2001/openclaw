...
const cases = [
  ...
  ["Amp thread link on its own line", commit({ message: "Fix shaper\n\nhttps://ampcode.com/threads/T-01a021f5-984a\n" }), "amp"],
  ["Amp thread mentioned in prose", commit({ message: "Fix shaper\n\nSee the [shaper](https://ampcode.com/threads/T-1) discussion.\n" }), "human"],
  ["human who works at Amp", commit({ message: "x\n\nCo-authored-by: Tim <tfc@ampcode.com>\n" }), "human"],
